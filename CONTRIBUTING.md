# Contributing to NodeView

Thanks for your interest in contributing to NodeView! ❤️
...
You will need Python 3.10 or later and the C++ compiler for your platform installed before you are able to build NodeView. The compilers used for each platform are as follows:
...
NodeView uses the C++17 standard.
...
From the project root directory run the following commands to install the dependencies and build NodeView:
...
If you are using Windows, once run, you can open `build/NodeView.sln` in Visual Studio to use Visual Studio for development and debugging.
...
If you need to publish build artifacts to your local Conan cache manually, after completing the [building](#building) steps, you can run the following commands to package NodeView and publish it to your local Conan cache:
